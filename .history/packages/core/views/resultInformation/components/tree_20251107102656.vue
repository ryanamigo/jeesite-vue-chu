  ...
  <div class="task-tree-container">
    ...
    >
      <a-form :model="addForm" :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item label="部别" required>
          <TreeSelect
            v-model:value="addForm.department"
            v-model:label="addForm.departmentsName"
            :api="companyTreeData"
            allow-clear
            :can-select-root="false"
            :can-select-parent="false"
            checkbox
            :chkbox-type="{ Y: 's', N: 'sp' }"
          />
        </a-form-item>
      </a-form>
    </a-modal>
...
.task-tree-container {
  ...
  .tree-header {
    ...
    align-items: center;
    padding: 12px;
    border-bottom: 1px solid hsla(324, 85%, 46%, 0.571);
