      ...
      <div class="comprehensive_data">
        ...
        <div class="fr">
          ...
          <div class="filter-item age-filter">
            ...
            <div class="age-range">
              <input type="number" v-model="filterParams.startAge" class="layui-input"  min="0">
              <span class="age-separator">-</span>
              <input type="number" v-model="filterParams.endAge" class="layui-input"  min="0">
            </div>
          </div>
